// Code generated by "enumer -type=ModelType -trimprefix=Model -transform=snake -values -text -json -yaml gomlx.go"; DO NOT EDIT.
...
const _ModelTypeName = "nonefnnalpha_zero_fnn"

var _ModelTypeIndex = [...]uint8{0, 4, 7, 21}

const _ModelTypeLowerName = "nonefnnalpha_zero_fnn"
...
func _ModelTypeNoOp() {
	...
	_ = x[ModelNone-(0)]
	_ = x[ModelFNN-(1)]
	_ = x[ModelAlphaZeroFNN-(2)]
}

var _ModelTypeValues = []ModelType{ModelNone, ModelFNN, ModelAlphaZeroFNN}
...
var _ModelTypeNameToValueMap = map[string]ModelType{
	...
	_ModelTypeName[7:21]:      ModelAlphaZeroFNN,
	_ModelTypeLowerName[7:21]: ModelAlphaZeroFNN,
}
